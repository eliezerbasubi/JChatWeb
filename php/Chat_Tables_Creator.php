...
if($check_table_existence>0){
	...
	$create_table_query = "CREATE TABLE $selected_Username_Table(ID INT(11) NOT NULL PRIMARY KEY AUTO_INCREMENT, Messages LONGTEXT NOT NULL, Time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, Usernames VARCHAR(50) NOT NULL,Time_sent VARCHAR(50) NOT NULL)";
