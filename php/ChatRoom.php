...
if($rows["Usernames"]==$_COOKIE["user_first_name"]){
 	echo "<div class='sender'><span class='original_sender'><span style='color:black;' class='current_time'>".$rows["Time_sent"]."</span><div class='shape_sender'>".$rows["Messages"]."</div></span></div>";
}else{
 	echo "<div class='receiver'><span class='original_receiver'><div class='shape_receiver'>".$rows["Messages"]."</div></span>
 	<span class='current_time'>".$rows["Time_sent"]."</span></div>";
}
